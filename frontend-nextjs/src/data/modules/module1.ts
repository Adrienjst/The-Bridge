    ...
    lessons: [
        {
            ...
            content: [
                ...
                {
                    type: 'interactive',
                    title: { fr: 'Simulation : Long Call', en: 'Simulation: Long Call' },
                    body: {
                        fr: 'Ajustez le strike et la prime ci-dessous pour voir l\'impact sur le P&L à maturité.',
                        en: 'Adjust the strike and premium below to see the impact on P&L at maturity.'
                    },
                    chartConfig: { strategy: 'call', params: { strike: 100, premium: 5 } }
                },
                {
                    type: 'key-concept',
                ...
                {
                    type: 'interactive',
                    title: { fr: 'Simulation : Long Put', en: 'Simulation: Long Put' },
                    body: {
                        fr: 'Le gain maximum est cappé si le sous-jacent tombe à zéro. Ajustez les paramètres pour visualiser.',
                        en: 'Maximum gain is capped if the underlying falls to zero. Adjust parameters to visualize.'
                    },
                    chartConfig: { strategy: 'put', params: { strike: 100, premium: 5 } }
                },
                {
                    type: 'formula',
